...
ETHERS_ACCOUNT_GET_TRANSACTION_COST_SUCCESS,
ETHERS_ACCOUNT_GET_TRANSACTION_COST_FAILURE,
...
export default (state = initialState, {type, payload, metadata}) => {
  switch (type) {
      ...
      case ETHERS_ACCOUNT_GET_TRANSACTION_COST_REQUEST:
        return {
          ...state,
          [metadata.delta]: {
            ...state[metadata.delta],
      ...
      case ETHERS_ACCOUNT_GET_TRANSACTION_COST_SUCCESS:
        return {
          ...state,
          [metadata.delta]: {
            ...state[metadata.delta],
      ...
      case ETHERS_ACCOUNT_GET_TRANSACTION_COST_FAILURE:
        return {
          ...state,
          [metadata.delta]: {
            ...state[metadata.delta],
